...
if __name__ == '__main__':
    scenario_path = (r"E:\BaiduSyncdisk\process-code-test\tests\thesis_master\chapter3\weaving-analysis\data"
                     r"\pattern_scenario_data.pkl")
    ...
    for pattern_name, pattern_traj_s in scenario_data.items():
        ...
        for pattern_traj in pattern_traj_s:
            ...
            surr_class = SurrClass(
                ...
                cp_type=V_CLASS.GAME_OV,
                cr_type=V_CLASS.GAME_OV,
                tr_type=V_CLASS.GAME_OV,
                tp_type=V_CLASS.GAME_OV,
            )
            sce = LcScenario(pattern_traj, surr_class)
