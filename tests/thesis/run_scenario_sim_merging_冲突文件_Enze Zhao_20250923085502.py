...
def run_road(road: Road):
    ...
    # plot_stra(TR_stra_dict, sim_step, fig_name, type_="TR")
    # plot_stra(TP_stra_dict, sim_step, fig_name, type_="TP")
...
# def plot_data(sim, fig_name):
#     traj_s, traj_names = load_from_pickle(rf"data\{fig_name}_traj_s.pkl")
#     plot_scenario_twin(
#         traj_s, traj_names=traj_names,
#         road=sim, fig_name=fig_name, ori_plot=False
#     )
#
#     ttc_s = []
#     eff_s = []
...
if __name__ == '__main__':
    sim = make_road()
    run_road(sim)
    # plot_data(sim, fig_name=f"merging_TR-HV-False_TP-HV-False")
